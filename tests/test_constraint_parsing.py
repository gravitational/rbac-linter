...
def test_parse_template_constraint():
  ...
  for value in values:
    ...
    unparsed = f'{{{{{expected.trait_type}.{expected.trait_key}}}}}' if None == expected.inner_trait_key \
...
def test_parse_interpolation_constraint():
  ...
  for value in values:
    ...
    unparsed = f'{expected.prefix}{{{{{expected.trait_type}.{expected.trait_key}}}}}{expected.suffix}' if None == expected.inner_trait_key \
...
def test_parse_email_function_constraint():
  ...
  for value in values:
    ...
    unparsed = f'{{{{email.local({expected.trait_type}.{expected.trait_key})}}}}' if None == expected.inner_trait_key \
